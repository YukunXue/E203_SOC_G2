...
## Clock Signal
set_property -dict {PACKAGE_PIN AD11 IOSTANDARD LVDS} [get_ports clk_1n_0]
set_property -dict {PACKAGE_PIN AD12 IOSTANDARD LVDS} [get_ports clk_1p_0]
create_clock -period 5.000 -name sys_clk_pin -waveform {0.000 2.500} -add [get_ports clk_1p_0]


set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets design_1_i/E203_AXI_V2_0/inst/IOBUF_jtag_TCK/O]
...
## LEDs
set_property -dict {PACKAGE_PIN T28 IOSTANDARD LVCMOS33} [get_ports {led_0[0]}]
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {led_0[1]}]
set_property -dict {PACKAGE_PIN U30 IOSTANDARD LVCMOS33} [get_ports {led_0[2]}]
set_property -dict {PACKAGE_PIN U29 IOSTANDARD LVCMOS33} [get_ports {led_0[3]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {led_0[4]}]
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports led_singal]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS33} [get_ports pmu_paden_0]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS33} [get_ports pmu_padrst_0]
...
set_property -dict {PACKAGE_PIN P27 IOSTANDARD LVCMOS33} [get_ports mcu_wakeup_0]
...
## PMOD Header JC
#set_property -dict { PACKAGE_PIN AC26   IOSTANDARD LVCMOS33 } [get_ports { mcu_TDI_0 }]; #IO_L19P_T3_13 Sch=jc[1]
#set_property -dict { PACKAGE_PIN AJ27   IOSTANDARD LVCMOS33 } [get_ports { mcu_TMS_0 }]; #IO_L20P_T3_13 Sch=jc[2]
set_property -dict {PACKAGE_PIN AH30 IOSTANDARD LVCMOS33} [get_ports uart0_tx_0]
set_property -dict {PACKAGE_PIN AK29 IOSTANDARD LVCMOS33} [get_ports uart0_rx_0]
set_property KEEPER true [get_ports mcu_TMS_0]
set_property -dict {PACKAGE_PIN AD26 IOSTANDARD LVCMOS33} [get_ports mcu_TDI_0]
set_property -dict {PACKAGE_PIN AG30 IOSTANDARD LVCMOS33} [get_ports mcu_TMS_0]
set_property -dict {PACKAGE_PIN AK30 IOSTANDARD LVCMOS33} [get_ports mcu_TDO_0]
set_property -dict {PACKAGE_PIN AK28 IOSTANDARD LVCMOS33} [get_ports mcu_TCK_0]
...
set_property IOSTANDARD LVCMOS33 [get_ports {qspi0_dq_0[0]}]
set_property IOB TRUE [get_ports {qspi0_dq_0[0]}]
set_property PACKAGE_PIN P24 [get_ports {qspi0_dq_0[0]}]
set_property PULLUP true [get_ports {qspi0_dq_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi0_dq_0[1]}]
set_property IOB TRUE [get_ports {qspi0_dq_0[1]}]
set_property PACKAGE_PIN R25 [get_ports {qspi0_dq_0[1]}]
set_property PULLUP true [get_ports {qspi0_dq_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi0_dq_0[2]}]
set_property IOB TRUE [get_ports {qspi0_dq_0[2]}]
set_property PACKAGE_PIN R20 [get_ports {qspi0_dq_0[2]}]
set_property PULLUP true [get_ports {qspi0_dq_0[2]}]
set_property PACKAGE_PIN R21 [get_ports {qspi0_dq_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi0_dq_0[3]}]
set_property IOB TRUE [get_ports {qspi0_dq_0[3]}]
set_property PULLUP true [get_ports {qspi0_dq_0[3]}]
